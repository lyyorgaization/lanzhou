<template>
    <div class="header">
        ...
        <div class="logo">甘肃工程地质研究院数据处理中心</div>
        <div class="header-right">
            <div class="header-user-con">
                ...
                <el-dialog title="修改密码" :visible.sync="changePasswordVisible" width="40%" label-width="80px">
                    <el-form :model="form" :rules="rules">
                        <el-form-item ref="form" label-width="80px" label="旧密码">
                            <el-input placeholder="请输入旧密码" type="password" v-model="form.oldPassword" />
                        </el-form-item>
                        <el-form-item ref="form" label-width="80px" prop="newPassword" label="新密码">
                            <el-input placeholder="请输入新密码" type="password" v-model="form.newPassword" />
                        </el-form-item>
                        <el-form-item ref="form" label-width="80px" label="确认密码" prop="confirmPassword">
                            <el-input placeholder="请再次输入新密码" type="password" v-model="form.confirmPassword" />
                        </el-form-item>
                    </el-form>
